...
(NULL, 5, 1, NULL, '_____ that the insulation has been replaced, the building is much more energy-efficient.', NULL, 'A) Now', 'B) For', 'C) As', 'D) Though', 'C', 0, '“As” là từ nối phù hợp nhất để thể hiện lý do, giải thích sự thay đổi.'),
(NULL, 5, 1, NULL, 'The building owner purchased the property _____ three months ago, but she has already spent a great deal of money on renovations.', NULL, 'A) yet', 'B) just', 'C) few', 'D) still', 'B', 1, '“Just” được sử dụng để chỉ hành động xảy ra gần đây, tạo sự hợp lý cho câu.'),
(NULL, 5, 1, NULL, '_____ an ankle injury, the baseball player participated in the last game of the season.', NULL, 'A) In spite of', 'B) Even if', 'C) Whether', 'D) Given that', 'A', 0, '“In spite of” là cách diễn đạt hợp lý để chỉ việc làm gì đó mặc dù có khó khăn.'),
(NULL, 5, 1, NULL, '_____ seeking a position at Tulare Designs must submit a portfolio of previous work.', NULL, 'A) Anyone', 'B) Whenever', 'C) Other', 'D) Fewer', 'A', 1, '“Anyone” là từ chính xác để diễn đạt “bất kỳ ai” cần nộp hồ sơ khi xin việc.'),
...
(NULL, 5, 2, NULL, 'Having proper ventilation throughout the building is _____ for protecting the health and well-being of the workers.', NULL, 'A) cooperative', 'B) visible', 'C) essential', 'D) alternative', 'C', 1, '“Essential” có nghĩa là cần thiết, phù hợp trong ngữ cảnh bảo vệ sức khỏe công nhân.'),
...
(NULL, 5, 2, NULL, 'We would like to discuss this problem honestly and _____ at the next staff meeting.', NULL, 'A) rarely', 'B) tiredly', 'C) openly', 'D) highly', 'C', 0, '“Openly” là từ thích hợp vì nghĩa của nó là thảo luận một cách cởi mở, trung thực.'),
(NULL, 5, 2, NULL, 'The company started to recognize the increasing _____ of using resources responsibly.', NULL, 'A) more important', 'B) importantly', 'C) importance', 'D) important', 'C', 1, '“Importance” là danh từ, phù hợp với ngữ cảnh câu mô tả sự gia tăng tầm quan trọng của việc sử dụng tài nguyên.'),
(NULL, 5, 2, NULL, 'The upscale boutique Jane’s Closet is known for selling the most stylish _____ for young professionals.', NULL, 'A) accessorized', 'B) accessorize', 'C) accessorizes', 'D) accessories', 'D', 0, '“Accessories” là danh từ chính xác để chỉ các phụ kiện thời trang.'),
(NULL, 5, 3, NULL, 'Mr. Sims needs a more _____ vehicle for commuting from his suburban home to his office downtown.', NULL, 'A) expressive', 'B) reliable', 'C) partial', 'D) extreme', 'B', 1, '“Reliable” là từ chính xác để mô tả một phương tiện giao thông ổn định, tin cậy.'),
(NULL, 5, 3, NULL, '_____ restructuring several departments within the company, the majority of the problems with miscommunication have disappeared.', NULL, 'A) After', 'B) Until', 'C) Below', 'D) Like', 'A', 0, '“After” là sự lựa chọn đúng, diễn tả hành động xảy ra sau một sự kiện quan trọng.'),
(NULL, 5, 3, NULL, 'Mr. Ross, _____ is repainting the interior of the lobby, was recommended by a friend of the building manager.', NULL, 'A) himself', 'B) he', 'C) who', 'D) which', 'C', 1, '“Who” là đại từ quan hệ, chỉ người trong câu, thích hợp với ngữ pháp câu này.'),
...
(NULL, 5, 3, NULL, 'For optimal safety on the road, avoid _____ the view of the rear window and side-view mirrors.', NULL, 'A) obstructs', 'B) obstructed', 'C) obstruction', 'D) obstructing', 'D', 0, '“Obstructing” là động từ chính xác vì cần dùng dạng V-ing để chỉ hành động đang xảy ra.'),
(NULL, 5, 3, NULL, 'The company _____ lowered its prices to outsell its competitors and attract more customers.', NULL, 'A) strategy', 'B) strategically', 'C) strategies', 'D) strategic', 'B', 1, '“Strategically” là trạng từ mô tả cách thức công ty giảm giá, hợp lý trong câu này.'),
(NULL, 5, 3, NULL, 'When filling out the order form, please _____ your address clearly to prevent delays.', NULL, 'A) fix', 'B) write', 'C) send', 'D) direct', 'B', 0, '“Write” là động từ phù hợp vì chỉ việc ghi thông tin vào đơn hàng.'),
(NULL, 5, 3, NULL, 'The free clinic was founded by a group of doctors to give_____for various medical conditions.', NULL, 'A) treatment', 'B) treat', 'C) treated', 'D) treating', 'A', 1, '“Treatment” là danh từ, chỉ hành động chữa trị cho các bệnh nhân.'),
...
(NULL, 5, 3, NULL, 'Before beginning the new project, we will _____ all the current data on the market trends.', NULL, 'A) analyze', 'B) analyzes', 'C) analyzed', 'D) analyzing', 'A', 0, '“Analyze” là động từ nguyên thể, chỉ hành động phân tích trước khi bắt đầu dự án mới.');
Go
...
(NULL, 5, 1, NULL, 'Aurora Furnishings is finding it difficult to make a profit in its _____competitive market.', NULL, 'A) increases', 'B) increased', 'C) increasingly', 'D) increase', 'C', 0, '“Increasingly” là trạng từ chỉ mức độ ngày càng tăng trong thị trường cạnh tranh.'),
...
(NULL, 5, 1, NULL, 'We will make a final decision about changing the landscaping of the property after reviewing the _____ costs.', NULL, 'A) estimation', 'B) estimate', 'C) estimated', 'D) estimating', 'B', 0, '“Estimate” là danh từ chính xác, chỉ sự ước tính chi phí.'),
...
(NULL, 5, 1, NULL, 'The maintenance team’s repair requests should be _____ in groups according to the urgency.', NULL, 'A) organizing', 'B) organize', 'C) organized', 'D) organizes', 'C', 0, '“Organized” là tính từ miêu tả cách thức sắp xếp yêu cầu.'),
...
(NULL, 5, 2, NULL, 'Due to the high volume of foot traffic, the shop must polish its floors more _____ than usual during the peak season.', NULL, 'A) frequent', 'B) frequented', 'C) frequency', 'D) frequently', 'D', 0, '“Frequently” là trạng từ, chỉ hành động xảy ra thường xuyên.'),
...
(NULL, 5, 2, NULL, 'Financial advisors report that older investors tend to be_____ than their younger counterparts.', NULL, 'A) cautious', 'B) cautioned', 'C) more cautious', 'D) caution', 'C', 0, '“More cautious” là cụm từ miêu tả tính cẩn thận hơn của nhà đầu tư lớn tuổi.'),
...
(NULL, 5, 2, NULL, 'Despite having some problems with the sound system during the performance, the concert was an _____ experience for everyone.', NULL, 'A) enjoyable', 'B) enjoyment', 'C) enjoys', 'D) enjoyably', 'A', 0, '“Enjoyable” là tính từ mô tả sự trải nghiệm dễ chịu.'),
...
(NULL, 5, 2, NULL, 'The Parks and Recreation Department offers _____ opportunities for volunteers to improve the community.', NULL, 'A) reward', 'B) rewards', 'C) rewarded', 'D) rewarding', 'D', 0, '“Rewarding” là tính từ mô tả cơ hội mang lại lợi ích cho tình nguyện viên.'),
...
(NULL, 5, 3, NULL, 'As long as there are no further delays, the factory will be fully _____ by June 18.', NULL, 'A) operational', 'B) operate', 'C) operates', 'D) operation', 'A', 0, '“Operational” là tính từ miêu tả trạng thái hoạt động đầy đủ của nhà máy.'),
...
(NULL, 5, 3, NULL, 'Because of _____fuel costs, some people are choosing to stay home for the summer vacation rather than drive to tourist sites.', NULL, 'A) rising', 'B) above', 'C) dependable', 'D) lengthy', 'A', 0, '“Rising” là tính từ mô tả sự tăng lên của chi phí nhiên liệu.'),
...
(NULL, 5, 1, NULL, 'Mr. Burrows was praised for creating _____ user manuals which can be easily understood.', NULL, 'A) inform', 'B) informant', 'C) informs', 'D) informative', 'D', 0, '“Informative” là tính từ chỉ sự cung cấp thông tin hữu ích.'),
...
(NULL, 5, 2, NULL, 'Engaging in social _____, Ms. Mason quickly expanded her network after moving to a new city.', NULL, 'A) active', 'B) activities', 'C) activates', 'D) activated', 'B', 0, '“Activities” là danh từ, chỉ các hoạt động xã hội mà Ms. Mason tham gia.'),
...
(NULL, 5, 2, NULL, 'Unfortunately, when the hurricane hit the area, residents as well as public officials were _____ unprepared.', NULL, 'A) subsequently', 'B) totally', 'C) beneficially', 'D) currently', 'B', 0, '“Totally” là trạng từ chỉ sự chuẩn bị hoàn toàn không có gì.'),
...
(NULL, 5, 2, NULL, 'Fritz Center, the venue _____ hosts the film industry’s awards banquet is undergoing an ambitious expansion project.', NULL, 'A) that', 'B) where', 'C) what', 'D) even', 'A', 0, '“That” là đại từ quan hệ chỉ người, vật hoặc nơi chốn được xác định rõ.'),
...
(NULL, 5, 3, NULL, 'Landlords are required to _____ with the regulations set by the Regional Department of Safe Housing.', NULL, 'A) reinforce', 'B) comply', 'C) fulfill', 'D) interfere', 'B', 0, '“Comply” là động từ chỉ việc tuân thủ quy định.'),
...
(NULL, 5, 3, NULL, 'Despite receiving rejections from several major publishers, Ian Wright _____ to become a world-famous novelist.', NULL, 'A) gave up', 'B) figured out', 'C) brought down', 'D) went on', 'D', 0, '“Went on” nghĩa là tiếp tục theo đuổi mục tiêu bất chấp khó khăn.'),
...
(NULL, 5, 3, NULL, 'Ben Sanders _____ designed the suitcase to fold up easily for compact storage.', NULL, 'A) innovatively', 'B) innovate', 'C) innovative', 'D) innovation', 'C', 0, '“Innovative” là tính từ chỉ cách thức sáng tạo khi thiết kế.'),
...
(NULL, 5, 2, NULL, 'An additional route was added to the rail line to reduce travel times in the southern _____.', NULL, 'A) accent', 'B) function', 'C) distance', 'D) region', 'D', 0, '“Region” là danh từ chỉ khu vực, nơi việc di chuyển được tối ưu hóa.'),
...
(NULL, 5, 2, NULL, 'Buying a home for the first time can be complicated and even _____ without help from a licensed real estate agent.', NULL, 'A) nervous', 'B) risky', 'C) decreased', 'D) initial', 'B', 0, '“Risky” nghĩa là có thể gặp rủi ro khi không có sự trợ giúp.'),
...
(NULL, 5, 2, NULL, 'The semi-finalists for the community art contest will be _____ by a panel of judges tomorrow.', NULL, 'A) selected', 'B) ignored', 'C) prevented', 'D) complemented', 'A', 0, '“Selected” là động từ trong thì bị động, chỉ việc chọn ra người chiến thắng.'),
...
(NULL, 5, 2, NULL, '_____ the researcher’s report, eating fresh fruits and vegetables more often is a better health goal than avoiding fast food.', NULL, 'A) Even though', 'B) Rather than', 'C) According to', 'D) Because of', 'C', 0, '“According to” là cụm từ chỉ nguồn thông tin được trích dẫn.'),
...
(NULL, 5, 2, NULL, 'Joggers are asked to keep to the right side of the path, as _____ cyclists will need space to pass on the left.', NULL, 'A) many', 'B) each', 'C) much', 'D) either', 'D', 0, '“Either” có nghĩa là mỗi trong số hai đối tượng cần không gian.'),
...
(NULL, 5, 2, NULL, 'For the payment _____ last week, the necessary state and federal taxes must be paid by the recipient.', NULL, 'A) was remitted', 'B) remitted', 'C) remitting', 'D) to remit', 'B', 0, '“Remitted” là động từ trong quá khứ, chỉ hành động thanh toán.'),
...
(NULL, 5, 3, NULL, 'The manufacturing company’s recent _____ to reduce on-site accidents was appreciated by the staff.', NULL, 'A) attempt', 'B) industry', 'C) value', 'D) faculty', 'A', 0, '“Attempt” có nghĩa là sự nỗ lực thực hiện điều gì đó.'),
...
(NULL, 5, 3, NULL, 'The Garrison Theater will _____ allow student groups to view rehearsals during the day.', NULL, 'A) vaguely', 'B) substantially', 'C) occasionally', 'D) previously', 'C', 0, '“Occasionally” có nghĩa là thỉnh thoảng, không phải lúc nào cũng cho phép.'),
...
(NULL, 5, 3, NULL, 'Only _____ delegates wearing their ID badges will be allowed into the conference venue.', NULL, 'A) those', 'B) who', 'C) each', 'D) that', 'A', 0, '“Those” là đại từ chỉ người, hợp lý trong ngữ cảnh này.'),
...
(NULL, 5, 3, NULL, 'All of the trees on the property were damaged in the storm _______ the one near the rear entrance.', NULL, 'A) except', 'B) considering', 'C) still', 'D) along', 'A', 0, '“Except” là giới từ chỉ sự ngoại lệ, loại trừ cây gần lối vào sau.');
...
VALUES 
('PART6005', 6, 2, NULL, 
'This month, we _____ workshops for those interested in (2) _____ their computer skills with several classes on how to use Professional Office, create a personal website, and run the message app.', 
NULL, 
'A) correcting', 
'B) diminishing', 
'C) improving', 
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6022', 6, 1, NULL, 'This weekend the renovations to our second-floor offices (1) _____ .', NULL, 'A) has began', 'B) will begin', 'C) beginning', 'D) begun', 'B', 1, 'The correct answer is "will begin", which is the future tense used to indicate the start of the renovations.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6022', 6, 2, NULL, '(2) _____ , all cabinets and drawers should be locked.', NULL, 'A) Furthermore', 'B) As a consequence', 'C) Because', 'D) Therefore', 'A', 1, 'The correct answer is "Furthermore", as it is used to add more instructions to the previous statement.'),
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6023', 6, 1, NULL, 'The ideal candidate would have at least three years of experience (1) _____ with complex business transactions.', NULL, 'A) working', 'B) work', 'C) to work', 'D) worked', 'A', 1, 'The correct answer is "working", as it is the correct form of the verb following "experience" to indicate ongoing action.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6023', 6, 2, NULL, 'The ideal candidate would have at least three years of experience _____ with complex business transactions. (2) _____.', NULL, 'A) Government experience would also be a plus.', 'B) Working with children would help your resume.', 'C) Experience with animals is essential.', 'D) Working with disabled people is a bonus.', 'A', 1, 'The correct answer is "Government experience would also be a plus" as it relates to the desired qualifications for the position.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6023', 6, 3, NULL, 'The types of contract work that we (3) _____ at Johnson, Johnson, and Kindness deal exclusively with business relationships between private companies and the government.', NULL, 'A) perform', 'B) achieve', 'C) allow', 'D) transform', 'A', 1, 'The correct answer is "perform", as it refers to the type of work being carried out.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6023', 6, 3, NULL, 'If (4) _____ feel that you would be qualified to join our team, please e-mail our HR manager at JJC@law.com.', NULL, 'A) you', 'B) I', 'C) us', 'D) they', 'A', 1, 'The correct answer is "you", as the sentence is addressing the potential applicant directly.');
go
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6024', 6, 1, NULL, 'I am (1) _____ in response to the advertisement you placed in the Times about a new human resources manager.', NULL, 'A) message', 'B) to write', 'C) writing', 'D) looking', 'C', 1, 'The correct answer is "writing", as it is the correct form to use when introducing the action of replying to an advertisement.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6024', 6, 2, NULL, 'I have year’s (2) _____ working in a fast- paced corporate environment.', NULL, 'A) experience', 'B) knowledge', 'C) working', 'D) knowing', 'A', 1, 'The correct answer is "experience", as it refers to the amount of time spent working in the field.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6024', 6, 3, NULL, 'I understand that your firm employs upwards of 300 employees and many them are Spanish speaking. (3) _____.', NULL, 'A) I am a certified level-5 speaker of Spanish.', 'B) Spanish people can be hard to work with.', 'C) I don’t know any Spanish, but I could study.', 'D) Spanish speakers are good workers.', 'C', 1, 'The correct answer is "I don’t know any Spanish, but I could study", as it shows willingness to improve language skills for the role.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6024', 6, 3, NULL, 'I have attached my resume and would be happy (4) _____ provide excellent references should you request them.', NULL, 'A) in', 'B) to', 'C) for', 'D) will', 'B', 1, 'The correct answer is "to", as it follows the correct grammatical structure for expressing willingness to provide references.');
go
...
-- Câu hỏi cấp độ 2 (trung bình)
('PART6025', 6, 2, NULL, 'Most of all, we need someone who is personable, someone who can make customers feel (2)_____ , and someone who is passionate about fashion.', NULL, 'A) comfortable', 'B) appropriate', 'C) neglected', 'D) convenient', 'A', 1, 'The correct answer is "comfortable", as a salesperson should make customers feel at ease during their shopping experience.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6025', 6, 3, NULL, 'Payment will be by sales commission which gives employees more (3)_____ to serve their customers as best they can.', NULL, 'A) influence', 'B) incentive', 'C) insistence', 'D) consideration', 'B', 1, 'The correct answer is "incentive", as a commission structure motivates employees to perform better.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6025', 6, 3, NULL, 'If you (4)_____ in the position, please send your resume to Rita at rian@bboutique.com.', NULL, 'A) be interesting', 'B) were interesting', 'C) interest', 'D) are interested', 'D', 1, 'The correct answer is "are interested", as the present tense is needed when expressing current interest in the position.');
go
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6026', 6, 1, NULL, 'Handy Maids Home Service (1)_____ professional cleaning services for your business or home.', NULL, 'A) provide', 'B) provides', 'C) provided', 'D) providing', 'B', 1, 'The correct answer is "provides" because "Handy Maids Home Service" is a singular noun, requiring the singular form of the verb.'),
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6027', 6, 1, NULL, 'The information that you (1)_____ about changes to the hunting permit scheme has been enclosed.', NULL, 'A) provided', 'B) supply', 'C) request', 'D) requested', 'A', 1, 'The correct answer is "provided" because it refers to information that was given or made available previously.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6027', 6, 2, NULL, 'Each application (2)_____ enclosed in its own envelope and received before the applicable deadline.', NULL, 'A) won’t be', 'B) would be', 'C) must be', 'D) couldn’t be', 'C', 1, 'The correct answer is "must be" as it expresses a requirement or obligation for the applications to be submitted properly.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6027', 6, 3, NULL, '(3)_____. Because of this, you must plan your submissions in a timely fashion to make sure that you receive your permit while the applicable season is still open.', NULL, 'A) Received applications can take up to 5 weeks to process.', 'B) Applications are never approved before the season is over.', 'C) Sometimes applications get lost.', 'D) Never make an application in person.', 'A', 1, 'The correct answer is "Received applications can take up to 5 weeks to process." because it gives a timeframe for processing.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6027', 6, 3, NULL, 'I hope that the information (4)_____answers all of your questions. Take care and happy hunting.', NULL, 'A) enclose', 'B) enclosing', 'C) inclose', 'D) enclosed', 'D', 1, 'The correct answer is "enclosed" because it indicates that the information has already been provided or enclosed with the letter.');
go
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6028', 6, 1, NULL, 'For some (1)_____, we allowed sales reps to pay for their car rentals up front with their personal cards or cash and then be reimbursed later.', NULL, 'A) distances', 'B) place', 'C) event', 'D) time', 'D', 1, 'The correct answer is "time" because the context refers to a period in which a specific policy was followed.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6028', 6, 2, NULL, 'As of June 15, all payments for rentals were supposed to have (2)_____ with the company card that was assigned to each of you.', NULL, 'A) making', 'B) to be made', 'C) makes', 'D) been made', 'D', 1, 'The correct answer is "been made" because the phrase indicates a past action that should have been completed by the specified date.'),
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6029', 6, 1, NULL, 'In order to unlock, or lock, any door, you will (1) ______ assistance from the security team.', NULL, 'A) is requesting', 'B) has requested', 'C) have to request', 'D) had to request', 'C', 1, 'The correct answer is "have to request" because the sentence indicates a future requirement for assistance.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6029', 6, 2, NULL, 'The old system was reviewed and many vulnerabilities were discovered. (2) ______, the company has decided to replace the old system. This process should take three to four days.', NULL, 'A) Unfortunately', 'B) Therefore', 'C) Regardless', 'D) Finally', 'B', 1, 'The correct answer is "Therefore" because it shows a result or consequence of the vulnerabilities discovered.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6029', 6, 3, NULL, 'Please, feel free to stop by any time (3) ______ the day to collect yours.', NULL, 'A) upon', 'B) during', 'C) before', 'D) at', 'B', 1, 'The correct answer is "during" because it refers to a period of time within the day.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6029', 6, 3, NULL, 'Please, feel free to stop by any time ______ the day to collect yours. (4) ______.', NULL, 'A) The move from keys to keyless entry should make the facility more secure.', 'B) We will be looking forward to seeing you sometime next week.', 'C) The security office is open 24 hours a day.', 'D) This is for product security.', 'C', 1, 'The correct answer is "The security office is open 24 hours a day" because it clarifies when the cards can be collected.');
go
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6030', 6, 1, NULL, 'Mike’s Music School is (1) ______ seeking a new piano instructor for weekend and evening classes.', NULL, 'A) active', 'B) actived', 'C) actively', 'D) activated', 'C', 1, 'The correct answer is "actively" because it is the appropriate adverb to modify "seeking."'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6030', 6, 2, NULL, 'Mike’s Music School has been operating in the Central district since 1992. (2) ______.', NULL, 'A) Our company tries to work with outside communities.', 'B) Our commitment to the community is as important as our commitment to our students.', 'C) Our company is unique and uses strange instruments.', 'D) Our company is in a special location, next to the auto service center.', 'B', 1, 'The correct answer is "Our commitment to the community is as important as our commitment to our students." This matches the tone of the announcement.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6030', 6, 3, NULL, 'Applicants should be well versed in (3) ______ teaching techniques.', NULL, 'A) contemporary', 'B) unknown', 'C) strange', 'D) boring', 'A', 1, 'The correct answer is "contemporary" because it refers to current and modern teaching techniques, appropriate for the music field.'),
...
INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART6034', NULL, 'December 10\nDear Mr. Thompson,\nThank you for opening a checking account at Savers’ Bank. We have been providing our customers with high-quality services for more than 35 years, and we (1) ________ to do the same thing for you.\nWe are currently printing your checks. You should receive them no later (2) _________ December 15. Please note that most places in the city require you to present a form of picture ID when paying for goods or services with a check. (3) _________ In addition, we charge a $40 fee if you write a check on an overdrawn account.\nYou may feel free to contact one of our customer service representatives at 808-4243 at any time should you have any questions or comments regarding your account. We look forward to having a long and mutually (4) ___________ relationship with you.\nSincerely,\nCarla Hampton\nVice President\nSavers’ Bank');
go
...
-- Câu hỏi cấp độ 2 (trung bình)
('PART6034', 6, 2, NULL, 'You should receive them no later (2) _________ December 15.', NULL, 'A) from', 'B) within', 'C) than', 'D) by', 'D', 1, 'The correct answer is "by" because it refers to receiving the checks before or on a specified date.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6034', 6, 3, NULL, 'Please note that most places in the city require you to present a form of picture ID when paying for goods or services with a check. (3) _________', NULL, 'A) For instance, an electricity bill with your name on it is acceptable.', 'B) To make payments to these businesses, simply call us for more information.', 'C) In order to get paid, be sure that you have the proper identification on you.', 'D) In most cases, a driver’s license is considered acceptable by vendors.', 'D', 1, 'The correct answer is "In most cases, a driver’s license is considered acceptable by vendors." This gives specific information about the ID requirements when writing checks.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6034', 6, 3, NULL, 'We look forward to having a long and mutually (4) ___________ relationship with you.', NULL, 'A) beneficial', 'B) apparent', 'C) respective', 'D) suspicious', 'A', 1, 'The correct answer is "beneficial" because it refers to a positive and mutually advantageous relationship.');

go
INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART6035', NULL, 'Volunteers Needed\nThe Greenbrier Community Center is looking for volunteers to work during the summer months. We require people to teach some of the classes we hope to offer, and we could also use people to work at the information desk. (1) ________ with the time and ability to teach classes on painting, arts and crafts, needlepoint, and sewing are highly desired. (2) ________ Please call Mary Ashford at 3828594 for more information.\nWhile volunteers at the Greenbrier Community Center will not receive any (3) ________ compensation for their time, they will be rewarded in other ways. Anyone volunteering up to ten hours a week will receive 50% off the price of a yearly membership. And anyone who volunteers 20 hours or more each week will receive a free annual membership.\nBecome a volunteer at the Greenbrier Community Center. Help the residents of our community (4) ________ their lives by giving a bit of time from yours.');
go

INSERT INTO Questions (QuestionGroupID, PartID, Level, QuestionAudio, QuestionText, QuestionImage, AnswerA, AnswerB, AnswerC, AnswerD, CorrectAnswer, ExamQuestion, Explanation)
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6035', 6, 1, NULL, 'People (1) ________ with the time and ability to teach classes on painting, arts and crafts, needlepoint, and sewing are highly desired.', NULL, 'A) They', 'B) Them', 'C) These', 'D) Those', 'C', 1, 'The correct answer is "These" because it refers to the people who have the time and ability to teach classes, and "these" is used to refer to specific people being described.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6035', 6, 2, NULL, 'Please call Mary Ashford at 3828594 for more information. (2) ________', NULL, 'A) You will be paid well for the time that you spend with us.', 'B) So are people who would like to coach sports teams or act as referees.', 'C) We would also like someone to replace Ms. Ashford, who recently resigned.', 'D) There will not be any arts and crafts classes taught this summer.', 'B', 1, 'The correct answer is "So are people who would like to coach sports teams or act as referees." This provides additional information about other volunteer opportunities.') ,

-- Câu hỏi cấp độ 3 (khó)
('PART6035', 6, 3, NULL, 'While volunteers at the Greenbrier Community Center will not receive any (3) ________ compensation for their time, they will be rewarded in other ways.', NULL, 'A) finance', 'B) financial', 'C) financing', 'D) financier', 'B', 1, 'The correct answer is "financial" because it is the correct adjective form describing compensation (money-related).'),

-- Câu hỏi cấp độ 4 (khó)
('PART6035', 6, 3, NULL, 'Help the residents of our community (4) ________ their lives by giving a bit of time from yours.', NULL, 'A) improve', 'B) donate', 'C) dedicate', 'D) approach', 'A', 1, 'The correct answer is "improve" because it refers to making their lives better, which aligns with the goal of volunteering.');

go

INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART6036', NULL, 'To: All Staff Members, Accounting Department\nFrom: Darren Smith, Director, Accounting Department\nSubject: Restructuring\nDate: November 4\nIn the past two weeks, three of the employees in the Accounting Department have (1) ________ their positions to work at other companies. Unfortunately, HR has decided that only one of those positions (2) ________ with a new worker. As a result, all of us are going to take on additional duties to do the work that Jeb Marconi and Jenna Wilkins used to do.\nWe’re going to have a staff meeting to discuss this matter on Friday, November 6. It’s going to start at 9 in the morning and will end when we cover everything. (3) ________ Attendance at the meeting is mandatory, so please cancel all other plans or appointments you may have scheduled for that time. If you have any suggestions regarding this matter, please feel free to mention them at the meeting. I am interested in hearing everyone’s ideas on how we can assume extra duties without making our (4) _______ too heavy.');
GO

INSERT INTO Questions (QuestionGroupID, PartID, Level, QuestionAudio, QuestionText, QuestionImage, AnswerA, AnswerB, AnswerC, AnswerD, CorrectAnswer, ExamQuestion, Explanation)
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6036', 6, 1, NULL, 'In the past two weeks, three of the employees in the Accounting Department have (1) ________ their positions to work at other companies.', NULL, 'A) transferred', 'B) altered', 'C) suspended', 'D) resigned', 'A', 1, 'The correct answer is "transferred" because it indicates that the employees moved to different companies.'),
    
-- Câu hỏi cấp độ 2 (trung bình)
('PART6036', 6, 2, NULL, 'Unfortunately, HR has decided that only one of those positions (2) ________ with a new worker.', NULL, 'A) is filling', 'B) will fill', 'C) has been filled', 'D) will be filled', 'D', 1, 'The correct answer is "will be filled," indicating future action to hire a new worker for the position.'),
    
-- Câu hỏi cấp độ 3 (khó)
('PART6036', 6, 3, NULL, 'It’s going to start at 9 in the morning and will end when we cover everything. (3) ________ Attendance at the meeting is mandatory.', NULL, 'A) I anticipate that it will last for at least 2 hours.', 'B) The agenda for the meeting has not yet been set.', 'C) Please try to make it to the meeting if you have the time.', 'D) I will be the only one who will be speaking at the meeting.', 'A', 1, 'The correct answer is "I anticipate that it will last for at least 2 hours," which indicates the expected duration of the meeting.'),
    
-- Câu hỏi cấp độ 4 (khó)
('PART6036', 6, 3, NULL, 'without making our (4) _______ too heavy.', NULL, 'A) schedules', 'B) workloads', 'C) appointments', 'D) jobs', 'B', 1, 'The correct answer is "workloads" because it refers to the amount of work assigned, which is relevant in this context.');

GO
INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART6037', NULL, 'Darby’s Printing Services has just opened for business. We are located at 67 Washburn Avenue and are right across the street from the Whitman Steakhouse. (1) ________ we may be a new business, our employees are old hands at the printing industry. Clarence Darby, the owner, has more than five decades of experience in the industry, and his employees have been working for more than two decades each.\nTo celebrate the opening of our store, (3) ________ service we provide will be available at a 40% discount during our first week of business. So come here and have your company reports printed. Or request new business cards. We can print signs, advertisements, and posters as well: If it has anything to do with printing, we are the (4) __________. Call us at 701 -7649 or visit our website at www.darbysprinting.com to learn more about us and to see how much we charge for our services. We hope to see you soon.');
GO

INSERT INTO Questions (QuestionGroupID, PartID, Level, QuestionAudio, QuestionText, QuestionImage, AnswerA, AnswerB, AnswerC, AnswerD, CorrectAnswer, ExamQuestion, Explanation)
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6037', 6, 1, NULL, 'Darby’s Printing Services has just opened for business. (1) ________ we may be a new business, our employees are old hands at the printing industry.', NULL, 'A) Darby’s Printing Services is reopening its doors.', 'B) There’s a new store in town, and we want to serve you.', 'C) Thanks for making our first week in business a success.', 'D) Darby’s Printing Services is celebrating its tenth year of doing business.', 'B', 1, 'The correct answer is "There’s a new store in town, and we want to serve you." as it introduces the business clearly.'),
...
-- Câu hỏi cấp độ 3 (khó)
('PART6037', 6, 3, NULL, 'To celebrate the opening of our store, (3) ________ service we provide will be available at a 40% discount during our first week of business.', NULL, 'A) some', 'B) which', 'C) every', 'D) that', 'C', 1, 'The correct answer is "every" as it emphasizes all types of services available at a discount.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6037', 6, 3, NULL, 'If it has anything to do with printing, we are the (4) __________.', NULL, 'A) sellers', 'B) designers', 'C) architects', 'D) experts', 'D', 1, 'The correct answer is "experts" because it conveys a high level of knowledge and skill in the printing industry.');
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6038', 6, 1, NULL, 'After five days, the Odessa Spring Festival came to its (1) _________ yesterday.', NULL, 'A) conclusion', 'B) final', 'C) stop', 'D) over', 'A', 1, 'The correct answer is "conclusion" as it indicates the end of the festival.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6038', 6, 2, NULL, '(2) _________ This was the first time since 2011 that the festival received five straight days of sunny weather.', NULL, 'A) The festival’s organizers hope the sunny skies will attract many people.', 'B) Not as many people as expected visited the festival due to the heavy rain.', 'C) There were a number of problems at the festival, especially the weather.', 'D) This year’s festival was widely considered the most successful in recent years.', 'D', 1, 'The correct answer is "This year’s festival was widely considered the most successful in recent years." as it reflects the positive outcome of the event.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6038', 6, 3, NULL, 'which made for a more pleasant (3) _________ for most of the attendees.', NULL, 'A) attempt', 'B) experience', 'C) visualization', 'D) appearance', 'B', 1, 'The correct answer is "experience" because it refers to how attendees felt during the festival.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6038', 6, 3, NULL, 'who caught six fish (4) _________ a combined total of 11.4 kilograms.', NULL, 'A) weigh', 'B) weighted', 'C) weighing', 'D) weighs', 'C', 1, 'The correct answer is "weighing" which is the correct form to indicate the action of measuring the weight of the fish.');

GO

INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART6039', NULL, 'Wilma,\nAs you are aware, the orientation session for new employees is scheduled for next Monday, August 31. Unfortunately, there’s a slight problem. Matt Powell was supposed (1) _________ the session. However, he just submitted his resignation this morning, so the CEO doesn’t want him running the (2) _________. Mr. Jenkins instead suggested that you be responsible for everything.\nI know you’ve never done this before, but it’s a fairly straightforward (3) _______. I can get you up to speed on everything you need to do and let you know what must be done before next Monday as well. (4) _________ Why don’t we get together today? I’m going to be out of the office until around 2 in the afternoon. But I’m available any time after then until 6 in the evening. How about leaving a text message for me on my cell phone since I can’t check my e-mail while I’m out of the office? My number is (205) 365-8434.\nI will wait for your response.\nSincerely,\nChad Silva');
GO

INSERT INTO Questions (QuestionGroupID, PartID, Level, QuestionAudio, QuestionText, QuestionImage, AnswerA, AnswerB, AnswerC, AnswerD, CorrectAnswer, ExamQuestion, Explanation)
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6039', 6, 1, NULL, 'Matt Powell was supposed (1) _________ the session.', NULL, 'A) leading', 'B) led', 'C) to lead', 'D) have led', 'C', 1, 'The correct answer is "to lead" because it follows the structure of "was supposed to."'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6039', 6, 2, NULL, 'the CEO doesn’t want him running the (2) _________.', NULL, 'A) negotiation', 'B) program', 'C) ceremony', 'D) workplace', 'B', 1, 'The correct answer is "program" as it refers to the orientation session for new employees.'),
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6040', 6, 1, NULL, '(1) ________ HR is currently accepting applications for internal transfers.', NULL, 'A) We have just hired several new employees here.', 'B) It is time to start considering employees for promotions.', 'C) HR is currently accepting applications for internal transfers.', 'D) You need to prepare for your annual employee evaluations.', 'C', 1, 'The correct answer is "HR is currently accepting applications for internal transfers." as it directly relates to the content of the email.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6040', 6, 2, NULL, 'Any other paperwork that is required should be turned in (2) ________ your application.', NULL, 'A) in lieu of', 'B) regardless of', 'C) along with', 'D) with respect to', 'C', 1, 'The correct answer is "along with" because it indicates that the paperwork should be submitted together with the application.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6040', 6, 3, NULL, 'you must be (3) ________ in the primary language spoken in that particular country.', NULL, 'A) fluent', 'B) talkative', 'C) aware', 'D) prepared', 'A', 1, 'The correct answer is "fluent" as it means being able to speak a language smoothly and effortlessly, which is necessary for working in a foreign country.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6040', 6, 3, NULL, 'if you have any questions or concerns (4) ________ transferring.', NULL, 'A) regards', 'B) regardless', 'C) regarding', 'D) regarded', 'C', 1, 'The correct answer is "regarding" as it is used to indicate the subject of the questions or concerns about transferring.');
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6041', 6, 1, NULL, 'destinations (1) ________ the world.', NULL, 'A) over', 'B) to', 'C) around', 'D) within', 'C', 1, 'The correct answer is "around" as it indicates various destinations globally.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6041', 6, 2, NULL, 'Local budget airline Ace Airways will be the (2) ________ occupant of the terminal.', NULL, 'A) primate', 'B) primary', 'C) primed', 'D) priming', 'B', 1, 'The correct answer is "primary" because it refers to the main occupant of the terminal.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6041', 6, 3, NULL, '(3) ________ Its gates will be able to handle the largest passenger airliners in the world, too.', NULL, 'A) Passengers have already complimented the quality of items sold in the stores.', 'B) In addition, the gates are specifically designed for small commuter planes.', 'C) It is anticipated that they will bring in millions of dollars in revenue annually.', 'D) There is not yet anywhere for passengers to eat or to go shopping though.', 'C', 1, 'The correct answer is "It is anticipated that they will bring in millions of dollars in revenue annually." as it relates to the expected success of the terminal.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6041', 6, 3, NULL, 'and then passengers will be (4) ________ so that they can start going to their gates to catch their flights.', NULL, 'A) charged', 'B) admitted', 'C) dispatched', 'D) booked', 'B', 1, 'The correct answer is "admitted" as it implies that passengers will be allowed to enter the terminal to proceed to their gates.');
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6042', 6, 1, NULL, 'This increase applies both to individuals renting apartments (1) ________ those people who are renting office or commercial spaces.', NULL, 'A) and', 'B) so', 'C) or', 'D) that', 'A', 1, 'The correct answer is "and" as it connects the two groups of tenants affected by the rent increase.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6042', 6, 2, NULL, '(2) ________ I will be sending new contracts to all tenants within the next five business days.', NULL, 'A) There are unfortunately no more places available for rent at the moment.', 'B) There is no need for any of you to sign a new lease if you do not wish to do so.', 'C) All tenants must renegotiate the amount of rent that they pay sometime this week.', 'D) The rents are being increased to account for the recent rise in utilities prices.', 'D', 1, 'The correct answer is "The rents are being increased to account for the recent rise in utilities prices." as it explains the reason for the increase.'),
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6048', 6, 1, NULL, 'the bank (1) _________ a new branch in the downtown part of Hampton City.', NULL, 'A) opened', 'B) has opened', 'C) is opening', 'D) to open', 'B', 1, 'The correct answer is "has opened" as it indicates a recent action relevant to the present context.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6048', 6, 2, NULL, '(2) _________ Headquartered in Montgomery, the bank has been opening branch offices at a swift pace.', NULL, 'A) The shopping center recently closed due to poor sales.', 'B) Experts believe Bixby Bank must improve its services.', 'C) Bixby Bank is the state’s fastest growing bank.', 'D) This will be the first branch that the bank has opened.', 'C', 1, 'The correct answer is "Bixby Bank is the state’s fastest growing bank." as it aligns with the context of the bank’s expansion.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6048', 6, 3, NULL, 'thanks to its (3) _________ on customer relations and quality service.', NULL, 'A) emphasis', 'B) impression', 'C) consideration', 'D) dedication', 'A', 1, 'The correct answer is "emphasis" as it refers to the importance placed on customer relations and service quality.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6048', 6, 3, NULL, 'how well it (4) _________ its customers and which services it provides for them.', NULL, 'A) considers', 'B) treats', 'C) appoints', 'D) behaves', 'B', 1, 'The correct answer is "treats" as it describes how the bank interacts with its customers.' );
...
-- Câu hỏi cấp độ 2 (trung bình)
('PART6049', 6, 2, NULL, 'This change will apply to all apartments effective February 1. ---2---.', NULL, 'A) Tenants had found the new system easy to use.', 'B) From that day on, tenants must pay their rental fees online.', 'C) The new system allowed for a greater variety of payment options.', 'D) Only certain Wimberley Group occupants will be affected.', 'B', 1, 'The correct answer is "From that day on, tenants must pay their rental fees online." as it directly states the requirement after the change.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6049', 6, 3, NULL, 'After logging in, tenants will be able to ---3--- a payment.', NULL, 'A) postpone', 'B) cancel', 'C) oppose', 'D) make', 'D', 1, 'The correct answer is "make" as it is the appropriate verb for performing a payment action.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6049', 6, 3, NULL, '---4--- you hit “Pay”, the amount you designate will be deducted from your registered credit card or bank account.', NULL, 'A) Even though', 'B) During', 'C) Since', 'D) As soon as', 'D', 1, 'The correct answer is "As soon as" as it indicates the action that follows hitting the pay button.');
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6050', 6, 1, NULL, 'After sending it to our ---1--- for examination, we discovered that it contained a faulty component.', NULL, 'A) technicality', 'B) technical', 'C) technicians', 'D) technology', 'C', 1, 'The correct answer is "technicians" as it refers to the professionals who examine the laptop.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6050', 6, 2, NULL, 'At present, your laptop is being ---2---.', NULL, 'A) replaced', 'B) repaired', 'C) shipped', 'D) recalled', 'B', 1, 'The correct answer is "repaired" as it indicates the action being taken on the laptop.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6050', 6, 3, NULL, 'As this problem appears to have been entirely our fault, we will provide you with a $50 voucher to use at our retail store. ---3---, e-coupons for our Web site are also available.', NULL, 'A) Regrettably', 'B) Subsequently', 'C) Approximately', 'D) Alternatively', 'D', 1, 'The correct answer is "Alternatively" as it introduces another option available to the customer.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6050', 6, 3, NULL, '---4---. If you have not received it by then, please call customer service.', NULL, 'A) The model you inquired about is no longer available at this location.', 'B) We will send the computer back to you within three days.', 'C) You are not covered under the warranty as it has expired.', 'D) We have been receiving a number of complaints about our service.', 'B', 1, 'The correct answer is "We will send the computer back to you within three days." as it provides a specific timeline for the return of the laptop.');
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6051', 6, 1, NULL, 'The shopping mall our store is located in will be closed from December 24 to 26. ---1---, some of you will be coming in on December 24 to set up for our post-holiday sale.', NULL, 'A) Besides', 'B) Otherwise', 'C) Accordingly', 'D) However', 'D', 1, 'The correct answer is "However" as it introduces a contrast to the mall being closed.'),
...
-- Câu hỏi cấp độ 3 (khó)
('PART6051', 6, 3, NULL, 'It is vital that you ---3--- Daniel at the entrance at exactly 10 a.m.', NULL, 'A) are meeting', 'B) meet', 'C) had met', 'D) met', 'B', 1, 'The correct answer is "meet" as it is the correct form for the imperative mood in this context.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6051', 6, 3, NULL, 'so please be considerate and arrive as ---4---.', NULL, 'A) punctually', 'B) regularly', 'C) politely', 'D) impressively', 'A', 1, 'The correct answer is "punctually" as it indicates the importance of arriving on time.');
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6052', 6, 1, NULL, 'This annual ---1--- will verify that all labor laws are being followed.', NULL, 'A) meeting', 'B) investment', 'C) commemoration', 'D) assessment', 'D', 1, 'The correct answer is "assessment" as it refers to an evaluation process, which fits the context of an inspection.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6052', 6, 2, NULL, 'Your factory passed the ---2--- evaluation with no major problems.', NULL, 'A) decided', 'B) forthcoming', 'C) previous', 'D) ultimate', 'C', 1, 'The correct answer is "previous" as it refers to the last evaluation that was conducted.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6052', 6, 3, NULL, 'You are ---3--- obliged to provide access to any part of the factory that the inspectors may wish to see.', NULL, 'A) legally', 'B) legality', 'C) legal', 'D) legitimate', 'A', 1, 'The correct answer is "legally" as it describes the obligation in legal terms.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6052', 6, 3, NULL, 'Also, the inspectors need to confirm that workers are being properly compensated. ---4---.', NULL, 'A) A copy of the receipt for your recent payment has been sent to you in the mail', 'B) The human resources department will need to prepare the relevant documents.', 'C) Consequently, the company wishes to avoid paying any such penalties.', 'D) We are interested in hearing about certain products that were recalled.', 'B', 1, 'The correct answer is "The human resources department will need to prepare the relevant documents." as it directly relates to the inspectors’ need for documentation.');
...
VALUES
-- Câu hỏi cấp độ 1 (dễ)
('PART6053', 6, 1, NULL, 'Sensasia offers authentic ---1--- from China, Japan, India, Thailand, Korea, and Vietnam.', NULL, 'A) dishes', 'B) materials', 'C) components', 'D) directions', 'A', 1, 'The correct answer is "dishes" as it refers to the meals served in a restaurant.'),

-- Câu hỏi cấp độ 2 (trung bình)
('PART6053', 6, 2, NULL, '---2---. From Monday to Friday, enjoy handmade sushi prepared with fresh seafood, delicious Korean bibimbap, and tasty Vietnamese pho.', NULL, 'A) Our chefs use exotic seasonings in all of our grilled food.', 'B) Some parts of our restaurant are now being refurbished.', 'C) We serve a wide range of popular Asian cuisine every day.', 'D) Our food is delicious but limited to seafood selections.', 'C', 1, 'The correct answer is "We serve a wide range of popular Asian cuisine every day." as it summarizes the restaurant’s offerings.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6053', 6, 3, NULL, 'On weekends, Hong Kong style dim sum, consisting of various bite-size portions of food, ---3--- along with our regular menu items.', NULL, 'A) prepares', 'B) prepared', 'C) is prepared', 'D) preparing', 'C', 1, 'The correct answer is "is prepared" as it indicates the passive voice in this context.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6053', 6, 3, NULL, 'And once a month, our chefs introduce something new for diners to try. ---4---, only Sensasia can give you such a wide variety of meals in one location.', NULL, 'A) Conversely', 'B) In short', 'C) To that end', 'D) Not to mention', 'C', 1, 'The correct answer is "To that end" as it connects the chefs’ new offerings to the unique variety available at Sensasia.');
...
VALUES
-- Câu hỏi cấp độ 5 (dễ)
('PART6054', 6, 1, NULL, 'Our team has reviewed the draft, and we are ---1--- with the quality of the pamphlet thus far.', NULL, 'A) concerned', 'B) satisfied', 'C) credited', 'D) troubled', 'B', 1, 'The correct answer is "satisfied" as it indicates approval of the quality of the pamphlet.'),

-- Câu hỏi cấp độ 6 (trung bình)
('PART6054', 6, 2, NULL, 'In particular, there were minor layout and color errors and some important information was ---2--- as well.', NULL, 'A) allowed', 'B) asserted', 'C) moving', 'D) missing', 'D', 1, 'The correct answer is "missing" as it indicates that important information was not included.'),

-- Câu hỏi cấp độ 7 (khó)
('PART6054', 6, 3, NULL, 'We left notes in the brochure regarding where the omitted details should go. ---3---.', NULL, 'A) We are not sure why these details', 'B) We need each correction to be reflected precisely.', 'C) We would like you to change the entire layout.', 'D) We ask that you send the invoice for the design we chose.', 'B', 1, 'The correct answer is "We need each correction to be reflected precisely." as it emphasizes the importance of accuracy in revisions.'),

-- Câu hỏi cấp độ 8 (khó)
('PART6054', 6, 3, NULL, 'We will, of course, be happy to ---4--- the extra cost.', NULL, 'A) cover', 'B) covered', 'C) covering', 'D) covers', 'A', 1, 'The correct answer is "cover" as it is the correct verb form for this context.');
...
-- Câu hỏi cấp độ 2 (trung bình)
('PART6055', 6, 2, NULL, 'As a result, an overwhelming number of homeowners ---2--- assistance.', NULL, 'A) requests', 'B) were requested', 'C) have requested', 'D) had requested', 'C', 1, 'The correct answer is "have requested" as it indicates actions completed recently affecting the present situation.'),

-- Câu hỏi cấp độ 3 (khó)
('PART6055', 6, 3, NULL, 'An adjuster can inspect your property in a few days. ---3---.', NULL, 'A) You will need to submit your insurance claim as soon as possible.', 'B) He has provided you with the assistance you require.', 'C) Making this investment will raise your home’s market value.', 'D) If possible, start photographing the damaged areas of your home.', 'D', 1, 'The correct answer is "If possible, start photographing the damaged areas of your home." as it provides a practical action for the homeowner.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6055', 6, 3, NULL, 'Still, it may take some weeks to complete all the necessary forms and prepare a compensation ---4---.', NULL, 'A) score', 'B) estimate', 'C) history', 'D) receipt', 'B', 1, 'The correct answer is "estimate" as it refers to an assessment of costs for repairs.');
GO
...
VALUES
-- Câu hỏi cấp độ 5 (dễ)
('PART6056', 6, 1, NULL, 'We are now working to ---1--- the situation.', NULL, 'A) maintain', 'B) inspect', 'C) address', 'D) ignore', 'C', 1, 'The correct answer is "address" as it means to deal with or focus on a problem.'),

-- Câu hỏi cấp độ 6 (trung bình)
('PART6056', 6, 2, NULL, 'A printed guide will give management and staff an official reference on the performance of daily tasks. ---2---.', NULL, 'A) A provisional copy of this handbook will be distributed at the next meeting.', 'B) Your comments on the revised manual were very much appreciated.', 'C) A copy of the article may be found in last months company newsletter.', 'D) We are glad that everyone is now up-to-date on our meeting schedule.', 'A', 1, 'The correct answer is "A provisional copy of this handbook will be distributed at the next meeting." as it relates to the distribution of the guide.'),

-- Câu hỏi cấp độ 7 (khó)
('PART6056', 6, 3, NULL, 'Hopefully, it will help move us closer to our goal of having firmly ---3--- policies.', NULL, 'A) establish', 'B) established', 'C) establishing', 'D) establishment', 'B', 1, 'The correct answer is "established" as it is the correct past participle form used in this context.'),

-- Câu hỏi cấp độ 8 (khó)
('PART6056', 6, 3, NULL, 'The final version will also be ---4--- through the companys internal network.', NULL, 'A) access', 'B) accessible', 'C) accesses', 'D) accessing', 'B', 1, 'The correct answer is "accessible" as it describes the condition of the final version being available through the internal network.');
GO
...
-- Câu hỏi cấp độ 3 (khó)
('PART6057', 6, 3, NULL, 'On ---3--- violations, vehicles will be towed at the owner expense.', NULL, 'A) flexible', 'B) technical', 'C) exemplary', 'D) subsequent', 'D', 1, 'The correct answer is "subsequent" as it refers to violations that occur after the initial offenses.'),

-- Câu hỏi cấp độ 4 (khó)
('PART6057', 6, 3, NULL, 'Repeated negligence could also ---4--- to the suspension of a driver license.', NULL, 'A) lead', 'B) leads', 'C) led', 'D) leading', 'A', 1, 'The correct answer is "lead" as it is the correct verb form to indicate a potential outcome.');
GO
...
-- Câu hỏi 11
('PART7004', 7, 3, NULL, 'According to the article, what can be found on the website?', NULL, 'A) A transcript of a speech', 'B) An application for an open position', 'C) Details about upcoming contests', 'D) A list of Ms. Holt’s accomplishments', 'C', 1, 'The article mentions that the website contains information about upcoming contests, so the correct answer is "Details about upcoming contests."');
GO


INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART7005', NULL, 'To: Stacey Johnson <sjohnson@toplineelec.com>\nFrom: Josh Fleck <jfleck@toplineelec.com>\nDate: October 22\nSubject: Strategic Planning\n\nDear Ms. Johnson,\n\nDistrict Management at Topline Electronics would like to inform you about a new development that will be affecting your store. Another competing consumer electronics store will be opening in the Crayville area on November 12.\n\nIn order to ensure that Topline Electronics does not lose business to this new store, District Management is advising you to run a special sale on our new line of curved UHD televisions. These televisions provide state-of-the-art features at moderate prices. By showing your customers that Topline Electronics offers the best deals in the area, you will be able to maintain customer loyalty. We will be shipping the new televisions to your store within the next week. We suggest you prepare a prominent display space in your store to feature them. You should also update your website to advertise the sale.\n\nSmooth communication between you and US is vital to effective operational practices. If you have any questions concerning the new televisions or the marketing campaign in general, please don’t hesitate to contact District Management.\n\nSincerely,\nJosh Fleck District Manager,\nTopline Electronics');
GO

INSERT INTO Questions (QuestionGroupID, PartID, Level, QuestionAudio, QuestionText, QuestionImage, AnswerA, AnswerB, AnswerC, AnswerD, CorrectAnswer, ExamQuestion, Explanation)
VALUES
-- Câu hỏi 12
('PART7005', 7, 1, NULL, 'Who most likely is Ms. Johnson?', NULL, 'A) A store manager', 'B) A customer', 'C) A product developer', 'D) A marketing specialist', 'A', 1, 'Ms. Johnson is most likely a store manager as the letter addresses operational aspects of her store.'),

-- Câu hỏi 13
('PART7005', 7, 2, NULL, 'What is indicated about Topline Electronics?', NULL, 'A) It recently opened a new store location.', 'B) It will be relocated to the Crayville area.', 'C) It is concerned about market competition.', 'D) It was nominated for an annual award.', 'C', 1, 'The letter expresses concern about competition from a new store opening in Crayville.'),

-- Câu hỏi 14
('PART7005', 7, 3, NULL, 'What is Ms. Johnson NOT instructed to do?', NULL, 'A) Add new information to a website', 'B) Hire additional staff', 'C) Contact Management if necessary', 'D) Arrange a sale display area', 'B', 1, 'Ms. Johnson is not instructed to hire additional staff in the letter. The focus is on marketing and display space.' );
GO

INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART7006', NULL, 'Kyle          2:42\nNancy, it\ Kyle. Im in conference room B setting up for the meeting at 5. The projector doesnt work. Can you search for another in the supply room?\n\nNancy      2:45\nHey. No problem, Im headed there now.\n\nKyle         2:46\nThanks, I really appreciate it.\n\nNancy      2:57\nKyle, there are no projectors here. Ive called the IT department and asked if they have any spare ones. Ill get back to you when I get a reply.\n\nKyle         3:00\nThanks again. Oh and can you check for extra microphones?\n\nNancy      3:08\nThere are two here. Ill take them both.\n\nMeanwhile, the IT department says they dont have extra projectors but theyll send a guy down now to check whats wrong. They say it worked fine at yesterdays presentation.\n\nKyle         3:09\nGreat! Ill see you soon then.');
GO

INSERT INTO Questions (QuestionGroupID, PartID, Level, QuestionAudio, QuestionText, QuestionImage, AnswerA, AnswerB, AnswerC, AnswerD, CorrectAnswer, ExamQuestion, Explanation)
VALUES
-- Câu hỏi 15
('PART7006', 7, 1, NULL, 'Where most likely is Nancy?', NULL, 'A) At a conference room', 'B) At the IT department', 'C) In the supply room', 'D) In her office', 'C', 1, 'Nancy is in the supply room searching for a projector as per her conversation with Kyle.'),

-- Câu hỏi 16
('PART7006', 7, 2, NULL, 'What did Nancy mean when she said “I’m headed there now”?', NULL, 'A) She was going to the location.', 'B) She would lead the presentation.', 'C) She knew where the room was.', 'D) She was going straight to meet him.', 'A', 1, 'Nancy meant that she was going to the supply room as requested by Kyle, as indicated in her message.' );
GO

INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART7007', NULL, 'Fulton Stainless steel Products\n\nFulton Stainless steel Products is a large-scale manufacturer making stainless steel industrial kitchen appliances in factories in Germany and France. The company’s products are trusted by chefs and bakers around the world to be durable, long-lasting, and of superb quality. The company produces kitchen stoves, ovens, microwaves, refrigerators, food processors, electric kettles, coffee makers, and other products.\n\nAfter acquiring the Visor Home Products Company in a deal last month, the company expected its overall profits to increase 20% compared to the last fiscal year. As a result, to meet increased demand, the company will employ more than 300 full-time workers in our six factories and offer good pay with an excellent benefits package. The company considers all of its employees valuable members of the Fulton family. Additionally, the company continues to research and develop new products to satisfy its customers and compete with other companies.');
GO

INSERT INTO Questions (QuestionGroupID, PartID, Level, QuestionAudio, QuestionText, QuestionImage, AnswerA, AnswerB, AnswerC, AnswerD, CorrectAnswer, ExamQuestion, Explanation)
VALUES
-- Câu hỏi 17
('PART7007', 7, 1, NULL, 'Who is most likely to be a customer of Fulton Stainless steel Products?', NULL, 'A) A car manufacturer', 'B) A restaurant', 'C) A real estate agency', 'D) A clothing store', 'B', 1, 'The customers of Fulton Stainless Steel Products are likely to be restaurants since they make kitchen appliances, which are used by chefs and bakers.'),

-- Câu hỏi 18
('PART7007', 7, 2, NULL, 'What did Fulton Stainless steel Products do last month?', NULL, 'A) It held a press conference.', 'B) It opened a new factory.', 'C) It obtained a company.', 'D) It laid off some workers.', 'C', 1, 'Fulton Stainless Steel Products acquired the Visor Home Products Company last month, as mentioned in the text.'),

-- Câu hỏi 19
('PART7007', 7, 3, NULL, 'What is mentioned about Fulton Stainless Steel Products?', NULL, 'A) It recently provided extra funding for research and development.', 'B) It has released a budget proposal for next year.', 'C) It offers a benefits package to its part-time employees.', 'D) It plans to hire additional employees to work in factories.', 'D', 1, 'The company plans to hire more than 300 full-time workers to meet increased demand, as mentioned in the text.');
GO

INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART7008', NULL, 'Câu hỏi 20: What is being announced?\n(A) A renovation project\n(B) A store expansion\n(C) A change in operating hours\n(D) A work schedule\n\nCâu hỏi 21: When most likely is the construction NOT being performed?\n(A) On Monday\n(B) On Wednesday\n(C) On Saturday\n(D) On Sunday\n\nCâu hỏi 22: Why are customers asked to go to Patch Street?\n(A) To find a place to park\n(B) To visit a new store location\n(C) To take part in a promotional event\n(D) To receive a sample');
GO
...
-- Câu hỏi 21
('PART7008', 7, 2, NULL, 'When most likely is the construction NOT being performed?', NULL, 'A) On Monday', 'B) On Wednesday', 'C) On Saturday', 'D) On Sunday', 'C', 1, 'The construction is likely not being performed on Saturday as the business operates longer hours on this day (until 10:00 PM).'),

-- Câu hỏi 22
('PART7008', 7, 3, NULL, 'Why are customers asked to go to Patch Street?', NULL, 'A) To find a place to park', 'B) To visit a new store location', 'C) To take part in a promotional event', 'D) To receive a sample', 'A', 1, 'Customers are asked to go to Patch Street to find available public parking, as the store’s parking lot is inaccessible due to construction.');
GO
INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART7009', NULL, 'Câu hỏi 23: What is indicated about the Palmer Standard Cabin Yacht?\n(A) It is a fishing boat.\n(B) Its original paint color has been changed.\n(C) It can accommodate a group of people.\n(D) It is currently being repaired.\n\nCâu hỏi 24: What is NOT mentioned as a feature of the Palmer Standard Cabin Yacht?\n(A) Capability to play music\n(B) A lightweight construction material\n(C) Ample sleeping accommodations\n(D) A fuel-efficient engine\n\nCâu hỏi 25: What most likely is true about Mr. Thompson?\n(A) He will give a boat tour to a potential buyer.\n(B) He has young children.\n(C) He works at a shipyard.\n(D) He wants to sell the warranty separately.');
GO

INSERT INTO Questions (QuestionGroupID, PartID, Level, QuestionAudio, QuestionText, QuestionImage, AnswerA, AnswerB, AnswerC, AnswerD, CorrectAnswer, ExamQuestion, Explanation)
VALUES
-- Câu hỏi 23
('PART7009', 7, 1, NULL, 'What is indicated about the Palmer Standard Cabin Yacht?', NULL, 'A) It is a fishing boat.', 'B) Its original paint color has been changed.', 'C) It can accommodate a group of people.', 'D) It is currently being repaired.', 'C', 1, 'The Palmer Standard Cabin Yacht is described as being spacious and perfect for large families and social gatherings, indicating it can accommodate a group of people.'),

-- Câu hỏi 24
('PART7009', 7, 2, NULL, 'What is NOT mentioned as a feature of the Palmer Standard Cabin Yacht?', NULL, 'A) Capability to play music', 'B) A lightweight construction material', 'C) Ample sleeping accommodations', 'D) A fuel-efficient engine', 'D', 1, 'The Palmer Standard Cabin Yacht is not described as having a fuel-efficient engine. The features listed include an eight-speaker sound system, lightweight construction, and ample sleeping accommodations.'),

-- Câu hỏi 25
('PART7009', 7, 3, NULL, 'What most likely is true about Mr. Thompson?', NULL, 'A) He will give a boat tour to a potential buyer.', 'B) He has young children.', 'C) He works at a shipyard.', 'D) He wants to sell the warranty separately.', 'A', 1, 'Mr. Thompson is most likely to give a boat tour to a potential buyer as he is the contact person for viewing or testing the boat, which implies he will likely show the boat to interested buyers.');
GO

INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART7010', NULL, 'Câu hỏi 26: Why was a letter sent to Mr. Kang?\n(A) To remind him to send in his travel journals\n(B) To explain about a new subscription plan\n(C) To inquire about his travel plans\n(D) To determine his qualifications for a position\n\nCâu hỏi 27: What did Ms. Adams send with the letter?\n(A) A travel itinerary\n(B) A new contract\n(C) An application form\n(D) A revised schedule\n\nCâu hỏi 28: In the middle of the first paragraph of the letter, the term “at no extra cost” is closest in meaning to:\n(A) For a small fee\n(B) With a donation\n(C) Quite easily\n(D) For free\n\nCâu hỏi 29: In which of the positions marked [1], [2], [3] and [4] does the following sentence belong?\n“Your subscription expires next month, but we invite you to consider joining our VIP membership.”\n(A) [1]\n(B) [2]\n(C) [3]\n(D) [4]');
GO

INSERT INTO Questions (QuestionGroupID, PartID, Level, QuestionAudio, QuestionText, QuestionImage, AnswerA, AnswerB, AnswerC, AnswerD, CorrectAnswer, ExamQuestion, Explanation)
VALUES
-- Câu hỏi 26
('PART7010', 7, 1, NULL, 'Why was a letter sent to Mr. Kang?', NULL, 'A) To remind him to send in his travel journals', 'B) To explain about a new subscription plan', 'C) To inquire about his travel plans', 'D) To determine his qualifications for a position', 'B', 1, 'The letter explains a new subscription plan, inviting Mr. Kang to join a VIP membership.'),
...
-- Câu hỏi 28
('PART7010', 7, 3, NULL, 'In the middle of the first paragraph of the letter, the term “at no extra cost” is closest in meaning to:', NULL, 'A) For a small fee', 'B) With a donation', 'C) Quite easily', 'D) For free', 'D', 1, 'The phrase “at no extra cost” means that there is no additional charge for the service, or it is free of charge.'),

-- Câu hỏi 29
('PART7010', 7, 3, NULL, 'In which of the positions marked [1], [2], [3] and [4] does the following sentence belong?\n“Your subscription expires next month, but we invite you to consider joining our VIP membership.”', NULL, 'A) [1]', 'B) [2]', 'C) [3]', 'D) [4]', 'D', 1, 'The sentence is most likely to be placed in position [4] as it suggests an invitation for the VIP membership after mentioning the subscription expiry.' );
GO


INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART7011', NULL, 'Câu hỏi 1: What can be inferred about Ms. Russell?\n(A) She is Ms. Bennett’s co-worker.\n(B) She is planning a honeymoon.\n(C) She is currently engaged.\n(D) She works for a catering company.\n\nCâu hỏi 2: Who most likely is Ms. Bennett?\n(A) A professional musician\n(B) A wedding photographer\n(C) An interior designer\n(D) An event planner\n\nCâu hỏi 3: What is suggested about all the locations on the list?\n(A) They are close to a main road.\n(B) They are indoor venues.\n(C) They are located in the same city.\n(D) They require a down payment.\n\nCâu hỏi 4: What information is Ms. Russell asked to provide?\n(A) A potential date\n(B) A meal selection\n(C) A list of guests\n(D) A meeting location\n\nCâu hỏi 5: What package would probably best suit Ms. Russell’s needs?\n(A) Diamond\n(B) Emerald\n(C) Ruby\n(D) Sapphire');
GO
...
INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART7012', NULL, 'Câu hỏi 6: Who most likely is the lecture series intended for?\n(A) Community members\n(B) Building superintendents\n(C) University professors\n(D) Hospital patients\n\nCâu hỏi 7: In the brochure, the word “through” in paragraph 1, line 5, is closest in meaning to\n(A) over\n(B) via\n(C) across\n(D) until\n\nCâu hỏi 8: What most likely will be discussed at the lecture on February 10?\n(A) How to balance yearly budgets\n(B) How to meet infrastructure needs\n(C) How to avoid environmental damage\n(D) How to stimulate economic development\n\nCâu hỏi 9: According to Mr. Patterson, whose lecture must be rescheduled?\n(A) Mr. Watson’s\n(B) Mr. Ross’s\n(C) Ms. Simmons’s\n(D) Mr. Powell’s\n\nCâu hỏi 10: What is Ms. Flores instructed to do on a website?\n(A) Download a document\n(B) Change a room reservation\n(C) Update personal information\n(D) Facilitate a forum');
GO
...
INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES 
('PART7017', NULL, 'Câu hỏi 11: Where would the notice most likely be found?\n(A) In a restaurant\n(B) In a staff break room\n(C) In a shipping agency\n(D) In a grocery store\n\nCâu hỏi 12: What is indicated about the jars?\n(A) They were not closed tightly.\n(B) They are currently out of stock.\n(C) They were priced incorrectly.\n(D) They were delivered to the wrong address.\n\nCâu hỏi 13: According to the notice, what is NOT mentioned as advice for customers?\n(A) Avoiding consuming the product\n(B) Reporting on the product\n(C) Returning the product to a store\n(D) Purchasing other Castelli products\n\nCâu hỏi 14: In the e-mail to Mr. Hester, what additional gift does Castelli offer?\n(A) Pasta sauce\n(B) A recipe book\n(C) Vouchers for produce\n(D) Vouchers for new products\n\nCâu hỏi 15: Castelli is sending the vouchers for several reasons; what is NOT one of them?\n(A) To keep customers loyal\n(B) To say that they were sorry\n(C) To be fair to their customers\n(D) To gain new customers');
GO
