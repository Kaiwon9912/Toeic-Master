...
(NULL, 5, 3, NULL, '______ the outdated equipment is replaced with state-of-the-art machinery, productivity will be more than double.', NULL, 'A) Whether', 'B) Later', 'C) When', 'D) Momentarily', 'C', 1, '“When” chỉ thời điểm thay thế thiết bị cũ và năng suất được tăng lên.');(NULL, 5, 3, NULL, 'In order to be eligible for this position, you must have at least five years of experience in the insurance ______.', NULL, 'A) preservation', 'B) figure', 'C) industry', 'D) description', 'C', 1, '“Industry” là danh từ chỉ ngành công nghiệp bảo hiểm.'),
