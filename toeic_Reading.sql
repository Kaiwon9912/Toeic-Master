...
-- Câu hỏi 6
('PART7003', 7, 2, NULL, 'In which of the positions marked [1], [2], [3] and [4] does the following sentence belong?<br/>“Branford Construction, the development company that originally planned to build the shopping mall, is looking to build the mall outside of the Rivervalley Community.”', NULL, 'A) [1]', 'B) [2]', 'C) [3]', 'D) [4]', 'A', 1, 'The correct answer is "[1]" as the sentence provides context related to Branford Construction and its previous plans.'),
...
INSERT INTO QuestionGroup (QuestionGroupID, Audio, Content)
VALUES
('PART7020', NULL, 'Câu hỏi 11: What problem with the original shipment does Ms. Nelson report?<br/>(A) It was damaged.<br/>(B) It does not fit.<br/>(C) It arrived late.<br/>(D) It has not reached its destination.<br/><br/>Câu hỏi 12: In the e-mail from Debra Clarke, the phrase “as per” in paragraph 1, line 2, is closest in meaning to<br/>(A) regardless of<br/>(B) except for<br/>(C) rather than<br/>(D) according to<br/><br/>Câu hỏi 13: What is indicated about Ms. Nelson?<br/>(A) She recently moved to Denver.<br/>(B) She ordered a gift for a friend.<br/>(C) She has a Four Seasons Apparel Outlet membership.<br/>(D) She waited too long to request a refund.<br/><br/>Câu hỏi 14: What problem with the replacement shipment does Ms. Nelson report?<br/>(A) The size was incorrect.<br/>(B) The design was incorrect.<br/>(C) The size and design were incorrect.<br/>(D) Too much money was refunded to her from her original purchase.<br/><br/>Câu hỏi 15: When will Ms. Nelson return her Winter Festival sweater?<br/>(A) When she receives her correct order and the shipping refund.<br/>(B) When she has time.<br/>(C) When her husband is happy with his sweater.<br/>(D) When Four Seasons apologizes for her inconvenience.');
