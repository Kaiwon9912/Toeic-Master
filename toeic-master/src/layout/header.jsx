...
function Header()
{
    ...
    return(
      ...
      <p className="font-irish md:text-xl  uppercase w-20 font-bold">Toeic Master</p>
      ...
      <div className={`fixed  w-12 mt-20 z-50 h-[50%] rounded- bg-blue4 transition-all ${isOpen?'left-0':'-left-12'} `}>
          ...
          <ul className="px-1 space-y-3 ">
              <li className="p-2 rounded-full hover:bg-blue3 "><a href="/"><img src="https://cdn-icons-png.flaticon.com/512/25/25694.png"/></a></li>
              <li className="p-2 rounded-full hover:bg-blue3"><a href="#"><img src="https://cdn-icons-png.flaticon.com/512/27/27130.png"/></a> </li>
              <li className="p-2 rounded-full hover:bg-blue3"><a href="#/reading"><img src="https://cdn-icons-png.flaticon.com/128/171/171322.png"/></a> </li>
