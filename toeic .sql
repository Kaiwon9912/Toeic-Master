...
INSERT INTO Questions (
    QuestionGroupID, PartID, Level, QuestionText, 
    AnswerA, AnswerB, AnswerC, AnswerD, CorrectAnswer, Explanation
)
VALUES 
    (NULL, 5, 2, 
    N'When filling out the order form, please _____ your address clearly to prevent delays.', 
    N'fix', N'write', N'send', N'direct', 'B', 
    N'"Fix" có nghĩa là sửa chữa hoặc sắp xếp lại cái gì đó để nó hoạt động tốt hơn. "Write" mang nghĩa viết/điền thông tin vào tài liệu. "Send" là động từ chỉ hành động gửi đi cái gì đó. "Direct" có nghĩa là hướng dẫn hoặc chỉ dẫn ai đó làm gì đó. Trong ngữ cảnh "điền thông tin vào mẫu đơn", từ "write" là lựa chọn đúng nhất. => Khi điền vào đơn đặt hàng, vui lòng viết rõ địa chỉ của bạn để tránh sự chậm trễ. => Chọn đáp án B.'
);
...
INSERT INTO Exams (
    ExamID, ExamName, Level, Part1, Part2, Part3, Part4, Part5, Part6, Part7, DurationInMinutes
) VALUES (
    'EXAM2', 'Exam Part 5', 0, 0, 0, 0, 5, 0, 0, 0, 10
);
